// Vocabulary decomposition pass (Block 170, Sep 6 2026)
// Pre-reg: gallivanting/visual-studies/2026-09-06-vocab-prereg.md
// Two arms, draw-time styling only (RNG call structure identical to
// extinction-witnesses.js in ALL modes -> trail geometry bit-identical):
//   HUE_ONLY : hue lerp gold->smoke active; width frozen 1.2; opacity no tau fade.
//   FLAT_HUE : hue frozen gold; width 1.2->0.8; opacity x(1-0.25*tau) active.
// Verify: extract d="..." from SVGs and compare to committed styled/eraflat (geometry witness).
const fs = require('fs');
...
render(W1, 'study-xxviii-isolate-hueonly.svg', 'HUE_ONLY');
render(W1, 'study-xxviii-isolate-flathue.svg', 'FLAT_HUE');
render(W2, 'study-xxviii-giant-neighbor-hueonly.svg', 'HUE_ONLY');
render(W2, 'study-xxviii-giant-neighbor-flathue.svg', 'FLAT_HUE');
